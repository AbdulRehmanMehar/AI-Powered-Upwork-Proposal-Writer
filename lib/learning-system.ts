...
/**
 * Build a human-readable warning message from a stored failure record
 */
function buildWarningMessage(failure: ValidationFailure): string {
  // Use the stored error message directly — no hardcoded mapping needed
  return failure.errorMessage.substring(0, 150);
}
